...
from oving1 import arduino_connect
...
# up letters and digits in this dictionary.
    ...
    def reset(self):
        #self.current_message = '' bruker ikke
        self.current_word = ''
        self.current_symbol = ''
    ...
    def handle_symbol_end(self):
        try:
            self.update_current_word(self._morse_codes[self.current_symbol]) #sjekker etter key - derfor klammer []
            self.current_symbol= ''
        except KeyError:
            self.current_symbol =''
